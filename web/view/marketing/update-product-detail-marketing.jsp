...
<html>
    <head>
        ...
        <title>Marketing - Update Product Details</title>
        <style>
            body {
    ...
    <body>
        ...
        <div class="product-details">
            ...
            <div class="form-container">
                ...
                <form action="${pageContext.request.contextPath}/updateProductDetailMarketing" method="post" enctype="multipart/form-data">
