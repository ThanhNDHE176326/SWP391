...
<html lang="en">
    <head>
        ...
        <title>Order Information | BookHaven</title>
        <!-- Local Stylesheets -->
                    ...
                    <div class="col-sm-9 padding-right">
                        <div id="cart_items">
                            <div class="breadcrumbs">
                                <ol class="breadcrumb">
                                    <li><a href="${pageContext.request.contextPath}/listOrderCustomer">Back</a></li>
                            ...
                            <div class="order-details">
                                ...
                                <p data-status="${order.status_name}">
                                    Status: 
                                    <c:choose>
                                        <c:when test="${order.status_name == 'Restock successfully'}">
                                            Canceled
                                        </c:when>
                                        <c:otherwise>
                                            ${order.status_name}
