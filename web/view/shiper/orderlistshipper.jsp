        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper">
                <div class="container-fluid">
                    <h1>Orders List</h1>
                    <form action="${pageContext.request.contextPath}/shipperorderlist" method="get" style="margin-bottom: 20px;">
                    ...
                    <div>
                        <c:if test="${currentPage > 1}">
                            <a href="${pageContext.request.contextPath}/shipperorderlist?page=${currentPage - 1}&statusId=${statusId}&orderId=${orderId}">Previous</a>
                        </c:if>
                        ...
                        <c:if test="${currentPage < totalPages}">
                            <a href="${pageContext.request.contextPath}/shipperorderlist?page=${currentPage + 1}&statusId=${statusId}&orderId=${orderId}">Next</a>
                        </c:if>
                    </div>
                </div>
                <!-- /.container-fluid -->
