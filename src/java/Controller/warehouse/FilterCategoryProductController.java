 ...
 * @author Admin
 */
@WebServlet(name="FilterCategoryProductController", urlPatterns={"/filterCategoryProduct"})
public class FilterCategoryProductController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet FilterCategoryProductController</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet FilterCategoryProductController at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
