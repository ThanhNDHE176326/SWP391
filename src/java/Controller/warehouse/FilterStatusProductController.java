 ...
 * @author Admin
 */
@WebServlet(name="FilterStatusProductController", urlPatterns={"/filterStatusProductWH"})
public class FilterStatusProductController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet FilterStatusProductController</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet FilterStatusProductController at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
